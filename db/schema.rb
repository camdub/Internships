...
ActiveRecord::Schema.define(:version => 20120712200321) do
  ...
  create_table "myguide_long_term_goals", :force => true do |t|
    t.string   "name"
    t.text     "description"
    t.datetime "created_at",  :null => false
    t.datetime "updated_at",  :null => false
  ...
  create_table "myguide_long_term_goals_short_term_goals", :id => false, :force => true do |t|
    t.integer "long_term_goal_id"
    t.integer "short_term_goal_id"
  end

  create_table "myguide_short_term_goals", :force => true do |t|
    t.string   "name"
    t.text     "description"
  ...
  create_table "myguide_tags", :force => true do |t|
    t.string   "name"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  create_table "myguide_tasks", :force => true do |t|
    t.string   "name"
    t.text     "description"
    t.integer  "short_term_goal_id"
    t.datetime "created_at",         :null => false
  ...
  create_table "myguide_tasks_users", :id => false, :force => true do |t|
    t.integer "task_id"
    t.integer "user_id"
  end
