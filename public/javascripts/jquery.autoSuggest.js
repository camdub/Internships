...
(function($){
	$.fn.autoSuggest = function(data, options) {
		...
		/*Fix by Kory Calmes to work with Rails, however, this renders the system incapible of doing comma dilimeted, but, who would need that in rails?! */
		opts.preFill = eval(opts.preFill);
		/*end of fix */
